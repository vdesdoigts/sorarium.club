...
const colors = {
  ...
  layout: {
    ...
    sidebar: {
      ...
      menuItemBgActive: alpha(themeColors.primary, 0.2),
...
export const SorariumTheme = createTheme({
  // direction: i18n.dir(),
  colors: {
    backgrounds: {
      main: colors.layout.general.mainBg
    },
    gradients: {
  ...
  components: {
    ...
    MuiPaper: {
      styleOverrides: {
        ...
        outlined: {
          border: `1px solid ${alpha(themeColors.primaryBorder, 0.46)}`
        }
      }
    },
    MuiLink: {
